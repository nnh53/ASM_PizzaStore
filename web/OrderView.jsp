    ...
    <body>
        ...
        <div class="container">
            ...
            <%  OrderDAO dao = new OrderDAO();
                ...
                Account accLogin = (Account) currentSession.getAttribute("accountLoggedIn");
                if (accLogin != null && !accLogin.getType().equals("Staff")) {
                    ArrayList<Order> filterList = new ArrayList<Order>();
                    for (Order item : orderList) {
                        if (item.getCustomerID().equals(accLogin.getAccountID())) {
                            filterList.add(item);
                        }
                    }
